...
class HotelPanama : FancyHotels {
    ...
    var rooms = mutableListOf(
        Room(16, "Room 01", LocalDate.of(2020, 8, 2), true, true, 100.0),
        Room(17, "Room 02", LocalDate.of(2020, 8, 3), true, true, 120.0),
        Room(18, "Room 03", LocalDate.of(2020, 8, 4), true, true, 150.0),
        Room(19, "Room 04", LocalDate.of(2020, 8, 5), true, true, 180.0),
        Room(20, "Room 05", LocalDate.of(2020, 8, 6), true, true, 80.0),//cheapest price
        Room(21, "Room 06", LocalDate.of(2020, 5, 2), true, true, 80.0),//not able to book due to covid-19
        Room(22, "Room 07", LocalDate.now(), false, false, 100.0),
        Room(23, "Room 08", LocalDate.now(), false, false, 100.0),
        Room(24, "Room 09", LocalDate.now(), false, false, 100.0),
        Room(25, "Room 10", LocalDate.now(), false, false, 60.0),
        Room(26, "Room 11", LocalDate.now(), false, false, 50.0),
        Room(27, "Room 12", LocalDate.now(), false, false, 80.0),
        Room(28, "Room 13", LocalDate.now(), false, false, 40.0),
        Room(29, "Room 14", LocalDate.now(), false, false, 55.0),
        Room(30, "Room 15", LocalDate.now(), false, false, 700.0),
    )
    ...
    override fun findRooms(from: LocalDate, to: LocalDate): List<Room> {
        ...
        return rooms.stream().filter { rm ->
            ...
            .collect(Collectors.toList()).sortedBy { room: Room -> room.price }
    }
